...
from .views import MoodWallpaperQuizView, MoodWallpaperView, FinishWallpaperPublicView, PublicMoodWallpapersView, PersonalMoodWallpapersView
...
urlpatterns = [
    ...
    path('mood-wallpapers-personal/', PersonalMoodWallpapersView.as_view(), name='personal-wallpapers'),
]
